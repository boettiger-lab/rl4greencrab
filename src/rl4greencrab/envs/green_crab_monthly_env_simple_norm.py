...
class greenCrabMonthEnvSimpleNormalized(greenCrabMonthEnvSimple):
    def __init__(self, config={}):
        ...
        self.observation = {"crabs": np.array([-1], dtype=np.float32)}
    ...
    def step(self, action):
        ...
        self.observation = {"crabs": np.array([normalized_cpue[0]], dtype=np.float32)}
